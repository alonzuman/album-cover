import { getCover, getOrUpsertCover } from "@/app/actions";
...
async function Cover(props: { coverId: string }) {
  let cover = await getOrUpsertCover(props.coverId);

  // return (
  //   <div>
  //     <h1>Timeout</h1>
  //     <p>It took too long to generate the cover art, try refreshing the page</p>
  //   </div>
  // );
